    ...
    return (
      <g data-role="map-view">
        ...
        <g data-role="tools" transform={`translate(${13 * B},0)`}>
          ...
          <TextButton content="?" spreadX={0.125 * B} x={2.25 * B} y={2.75 * B} onClick={this.onShowHelpInfo} />
          <TextButton content="?" spreadX={0.125 * B} x={2.25 * B} y={4.25 * B} onClick={this.onShowHelpInfo} />
        </g>
      </g>
    );
  }
