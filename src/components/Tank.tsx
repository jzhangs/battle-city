      ...
      <g data-role="left-tire">
        ...
        {shape === 0 ? (
          <g data-role="left-tire-shape-0">
            ...
            {_.range(5).map(i => <rect key={i} x={1} width={2} y={5 + 2 * i} height={1} fill={c} />)}
          </g>
        ) : (
          <g data-role="left-tire-shape-1">
            <Bitmap x={1} y={4} d={['acc']} scheme={scheme} />
            <Bitmap x={1} y={14} d={['bcc']} scheme={scheme} />
            {_.range(4).map(i => <rect key={i} x={1} width={2} y={6 + 2 * i} height={1} fill={c} />)}
          </g>
        )}
      </g>
      ...
      <g data-role="right-tire">
        ...
        {shape === 0 ? (
          <g rdata-ole="right-tire-shape-0">
            {_.range(6).map(i => <rect key={i} x={12} width={2} y={4 + 2 * i} height={1} fill={b} />)}
          </g>
        ) : (
          <g data-role="right-tire-shape-1">
            {_.range(5).map(i => <rect key={i} x={12} width={2} y={5 + 2 * i} height={1} fill={b} />)}
          </g>
        )}
      </g>
  ...
  return (
    <g data-role="tank" transform={transform}>
      <g data-role="left-tire">
        ...
        {shape === 0 ? (
          ...
          <g data-role="left-tire-shape-1">
            ...
            {_.range(5).map(i => <rect key={i} x={1} width={2} y={6 + 2 * i} height={1} fill={c} />)}
          </g>
        )}
      </g>
      ...
      <g data-role="right-tire">
        ...
        <Pixel x={11} y={4} fill={a} />
        {shape === 0 ? (
          <g data-role="right-tire-shape-0">
            {_.range(6).map(i => <rect key={i} x={12} width={2} y={4 + 2 * i} height={1} fill={b} />)}
          </g>
        ) : (
          <g data-role="right-tire-shape-1">
            {_.range(6).map(i => <rect key={i} x={12} width={2} y={5 + 2 * i} height={1} fill={b} />)}
      ...
      <rect data-role="gun" x={7} y={0} width={1} height={7} fill={a} />
    </g>
  );
};
      ...
      <g data-role="left-tire">
        ...
        {shape === 0 ? (
          <g data-role="left-tire-shape-0">
            ...
            {_.range(5).map(i => <rect key={i} x={1} width={1} y={5 + 2 * i} height={1} fill={c} />)}
          </g>
        ) : (
          <g data-role="left-tire-shape-1">
            <Bitmap x={1} y={3} d={['aaa']} scheme={scheme} />
            {_.range(5).map(i => <rect key={i} x={1} width={1} y={4 + 2 * i} height={1} fill={c} />)}
          </g>
        )}
      </g>
      ...
      <g data-role="right-tire">
        ...
        {shape === 0 ? (
          <g data-role="right-tire-shape-0">
            ...
            {_.range(6).map(i => <rect key={i} x={13} width={1} y={4 + 2 * i} height={1} fill={b} />)}
          </g>
        ) : (
          <g data-role="right-tire-shape-1">
            <Bitmap x={11} y={3} d={['ab']} scheme={scheme} />
            {_.range(6).map(i => <rect key={i} x={13} width={1} y={3 + 2 * i} height={1} fill={b} />)}
          </g>
        )}
      </g>
...
const TankHumanArmor: TankComponent = ({ transform, color, shape }) => {
  ...
  const { a, b, c } = scheme;
  return (
    <g data-role="tank3" transform={transform}>
      <g data-role="left-tire">
        <rect x={1} y={1} width={1} height={14} fill={a} />
        <rect x={2} y={1} width={2} height={14} fill={b} />
        {shape === 0 ? (
          <g data-role="left-tire-shape0">
            {_.range(7).map(i => <rect key={i} x={1} y={2 * i + 2} width={1} height={1} fill={c} />)}
            <rect x={2} y={14} width={2} height={1} fill={c} />
          </g>
        ) : (
          <g data-role="left-tire-shape1">
            <Bitmap x={1} y={1} d={['bcc']} scheme={scheme} />
            {_.range(6).map(i => <rect key={i} x={1} y={2 * i + 3} width={1} height={1} fill={c} />)}
          </g>
        )}
      </g>
      <g data-role="right-tire">
        ...
        {shape === 0 ? (
          <g data-role="right-tire-shape0">
            {_.range(6).map(i => <rect key={i} x={14} y={2 * i + 2} width={1} height={1} fill={c} />)}
            <rect x={13} y={14} width={2} height={1} fill={c} />
          </g>
        ) : (
          <g data-role="right-tire-shape1">
            {_.range(7).map(i => <rect key={i} x={14} y={2 * i + 1} width={1} height={1} fill={c} />)}
...
const TankAIBasic: TankComponent = ({ transform, color, shape }) => {
  ...
  const { a, b, c } = scheme;
  return (
    <g data-role="tank4" transform={transform}>
      <g data-role="left-tire">
        <rect x={1} y={3} width={1} height={11} fill={a} />
        <rect x={2} y={3} width={2} height={11} fill={b} />
        {shape === 0 ? (
          <g data-role="left-tire-shape0">
            {_.range(5).map(i => <rect key={i} x={1} y={2 * i + 4} width={2} height={1} fill={c} />)}
          </g>
        ) : (
          <g data-role="left-tire-shape1">
            <Bitmap x={1} y={3} d={['bcc']} scheme={scheme} />
            {_.range(5).map(i => <rect key={i} x={1} y={2 * i + 5} width={2} height={1} fill={c} />)}
          </g>
        )}
      </g>
      <g data-role="right-tire">
        ...
        {shape === 0 ? (
          <g data-role="right-tire-shape0">
            {_.range(5).map(i => <rect key={i} x={12} y={2 * i + 4} width={2} height={1} fill={c} />)}
            <Pixel x={7} y={14} fill={b} />
          </g>
        ) : (
          <g data-role="right-tire-shape1">
            {_.range(6).map(i => <rect key={i} x={12} y={2 * i + 3} width={2} height={1} fill={c} />)}
      ...
      <g data-role="tank-body">
        ...
        <path d="M8,3 h1 v1 h1 v1 h1 v7 h-1 v1 h-1 v1 h-3 v-1 h2 v-1 h1 v-1 h1 v-4 h-1 v-1 h-1 v-3" fill={c} />
...
const TankAIFast: TankComponent = ({ transform, color, shape }) => {
  ...
  const { a, b, c } = scheme;
  return (
    <g data-role="tank5" transform={transform}>
      <g data-role="left-tire">
        ...
        {shape === 0 ? (
          <g data-role="left-tire-shape0">
            {_.range(3).map(i => <rect key={i} x={1} y={5 * i + 2} width={1} height={1} fill={b} />)}
          </g>
        ) : (
          <g data-role="left-tire-shape1">
            {_.range(3).map(i => <rect key={i} x={1} y={5 * i + 3} width={1} height={1} fill={b} />)}
          </g>
        )}
      </g>
      <g data-role="right-tire">
        ...
        {shape === 0 ? (
          <g data-role="right-tire-shape0">
            {_.range(3).map(i => <rect key={i} x={12} y={5 * i + 2} width={1} height={1} fill={b} />)}
            <Pixel x={7} y={14} fill={a} />
          </g>
        ) : (
          <g data-role="right-tire-shape1">
            {_.range(3).map(i => <rect key={i} x={12} y={5 * i + 3} width={1} height={1} fill={b} />)}
            <Pixel x={7} y={14} fill={b} />
          </g>
        )}
      </g>
...
const TankAIPower: TankComponent = ({ transform, color, shape }) => {
  ...
  const { a, b, c } = scheme;
  return (
    <g data-role="tank6" transform={transform}>
      <g data-role="left-tire">
        <rect x={1} y={3} width={1} height={12} fill={a} />
        <rect x={2} y={3} width={2} height={12} fill={b} />
        {shape === 0 ? (
          <g data-role="left-tire-shape0">
            {_.range(6).map(i => <rect key={i} x={1} y={2 * i + 4} width={2} height={1} fill={c} />)}
          </g>
        ) : (
          <g data-role="left-tire-shape1">
            <Bitmap x={1} y={3} d={['bcc']} scheme={scheme} />
      ...
      <g data-role="right-tire">
        ...
        {shape === 0 ? (
          <g data-role="right-tire-shape0">
            {_.range(6).map(i => <rect key={i} x={12} y={2 * i + 4} width={2} height={1} fill={c} />)}
            <Pixel x={7} y={14} fill={a} />
          </g>
        ) : (
          <g data-role="right-tire-shape1">
      ...
      <g data-role="tank-body">
        ...
        <path d="M8,3 h1 v1 h1 v1 h1 v7 h-1 v2 h-1 v1 h-1 v-1 h-1 v-1 h1 v-1 h1 v-1 h1 v-4 h-1 v-1 h-1 v-3" fill={c} />
        <path d="M7,7 h1 v2 h-1 v1 h-1 v-2 h1 v-1" fill={c} />
        <path d="M8,8 h1 v2 h-2 v-1 h1 v-1" fill={a} />
      </g>
      <g data-role="tank-gun">
...
const TankAIArmor: TankComponent = ({ transform, color, shape }) => {
  ...
  const { a, b, c } = scheme;
  return (
    <g data-role="tank7" transform={transform}>
      <g data-role="left-tire">
        <rect x={1} y={0} width={1} height={15} fill={a} />
        <rect x={2} y={0} width={2} height={15} fill={b} />
        {shape === 0 ? (
          <g data-role="left-tire-shape0">
            {_.range(7).map(i => <rect key={i} x={1} y={2 * i + 1} width={2} height={1} fill={c} />)}
          </g>
        ) : (
          <g data-role="left-tire-shape1">
            <Bitmap x={1} y={0} d={['bc']} scheme={scheme} />
            {_.range(7).map(i => <rect key={i} x={1} y={2 * i + 2} width={2} height={1} fill={c} />)}
          </g>
        )}
      </g>
      <g data-role="right-tire">
        ...
        {shape === 0 ? (
          <g data-role="right-tire-shape0">
            {_.range(7).map(i => <rect key={i} x={12} y={2 * i + 1} width={2} height={1} fill={c} />)}
            <Pixel x={7} y={14} fill={b} />
          </g>
        ) : (
          <g data-role="right-tire-shape1">
