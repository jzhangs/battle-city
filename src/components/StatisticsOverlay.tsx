    ...
    return (
      <g data-role="statistics-overlay">
        ...
        <g transform={`translate(${-0.5 * B}, ${-1.5 * B})`}>
          ...
          <Tank x={8 * B} y={7.7 * B} color="silver" side="ai" level="basic" direction="up" moving={false} />
          <Text content={'400 PTS  2\u2190'} x={2.5 * B} y={9.5 * B} fill="white" />
          <Tank x={8 * B} y={9.2 * B} color="silver" side="ai" level="fast" direction="up" moving={false} />
          <Text content={'  0 PTS  2\u2190'} x={2.5 * B} y={11 * B} fill="white" />
          <Tank x={8 * B} y={10.7 * B} color="silver" side="ai" level="power" direction="up" moving={false} />
          <Text content={'  0 PTS  0\u2190'} x={2.5 * B} y={12.5 * B} fill="white" />
          <Tank x={8 * B} y={12.2 * B} color="silver" side="ai" level="armor" direction="up" moving={false} />
