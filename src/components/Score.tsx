...
const Four = ({ x, y }: Point) => (
  <path role="four" d={`M${x + 1},${y + 2} v-1 h1 v-1 h1 v4 h-1 v-2 h-1 v2 h3 v1 h-1 v2 h-1 v-2 h-2 v-3 h1`} />
);

const Five = ({ x, y }: Point) => (
  <path role="five" d={`M${x},${y} h4 v1 h-3 v1 h2 v1 h1 v3 h-1 v1 h-2 v-1 h-1 v-1 h1 v1 h2 v-3 h-3 v-3`} />
);
